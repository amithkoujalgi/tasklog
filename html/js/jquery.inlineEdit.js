...
$.inlineEdit.prototype = {
    ...
    mutate: function() {
        ...
        return self
            ...
            .find( 'button.cancel' )
                .bind( 'click', function( event ) {
                	$("#searchInputs").focus().val("")
                	backingObject.activeSearchBox = "searchInputs";
                    self.change( self.element, event );
                    return false;
                })
            .end()
    ...
    controls: {
        ...
        input: function( value ) {
            return '<input type="text" style="width: 80%;" class="input-txt" id="currentSearch" value="'+ value.replace(/(\u0022)+/g, '') +'">' + this.buttonHtml();
        }
    },
